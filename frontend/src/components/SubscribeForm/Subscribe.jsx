...
export default function Subscribe () {
    ...
    return (
        <div>
            ...
            <form className="pl-1 text-base" onSubmit={handleSubmit}>
                <div className="pb-2">
                ...
                <button className=" bg-gray-700 hover:bg-yellow-600 text-white font-bold py-1 px-2 rounded">Subscribe</button>
            </form>
        </div>
    )
}
