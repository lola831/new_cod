        ...
        {/* <div className="mx-auto"> */}
            <Slider {...settings}>
                {dataReviews.map((review, index) => (
                    <div key={index} className="p-2 flex flex-col justify-between overflow-hidden rounded-lg shadow-xl review-card bg-blue-500 sm:bg-pink-600 md:bg-orange-600 h-[270px]">
